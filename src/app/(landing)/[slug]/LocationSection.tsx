              ...
              {hasModelhouse && (
                <div>
                  <div className="flex items-baseline gap-2 mb-2 flex-nowrap">
                    <h3 className="text-base md:text-xl font-bold whitespace-nowrap" style={{ color: primaryColor }}>
                      견본주택
                    </h3>
                    {modelhouse_address && (
                      <p className="text-xs md:text-[15px] text-gray-700 leading-snug whitespace-nowrap truncate">
                        {modelhouse_address}
                      </p>
                    )}
                  </div>
                  {modelhouse_kakao_url && (
                    <div className="mt-2">
                      <a
                        ...
                        className="w-full inline-flex items-center justify-center gap-1 px-4 py-2.5 rounded-md bg-[#FEE500] text-gray-900 text-sm md:text-[15px] font-semibold hover:brightness-95 transition-all"
                      >
                        <KakaoIcon />
                        카카오 지도 보기
                      </a>
